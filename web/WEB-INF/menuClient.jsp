                    ...
                    <nav class="navbar navbar-expand-md  navbar-white bg-light">
                        ...
                        <div class="collapse navbar-collapse " id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link active font-weight-bold px-3 px-3" aria-current="page" href="MenuClient">Mes comptes</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group col-md-8 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="LivretA" placeholder="**********879" >
                                </div> 
